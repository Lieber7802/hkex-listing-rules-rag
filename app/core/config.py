...
class Settings(BaseSettings):
    ...
    bm25_weight: float = Field(default=0.4, description="Weight for BM25 scores in hybrid fusion")
    dense_weight: float = Field(default=0.6, description="Weight for dense scores in hybrid fusion")
