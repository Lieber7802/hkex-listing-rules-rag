...
class ChatResponse(BaseModel):
    ...
    route_decision: Optional[Dict[str, Any]] = Field(default=None, description="Route decision from planner")
    ...
    extraction_log: Optional[Dict[str, Any]] = Field(default=None, description="Tool input extraction log")
