...
class PlannerOutput(BaseModel):
    ...
    tool_name: Optional[str] = Field(default=None, description="Tool to invoke (e.g. size_test_calculator, rule_lookup)")
    tool_mode: str = Field(default="none", description="Tool execution mode: none, tool_only, tool_plus_retrieval")
